...
> {
	return withSpan("service.drawFetcher.fetchLatest", { "draws.anbieter": _anbieter }, async (span) => {
		...
		span.setAttribute("draws.total", drawList.length);
		span.setAttribute("draws.new", newDraws.length);

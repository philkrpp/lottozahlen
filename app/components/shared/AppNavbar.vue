  ...
  >
    <v-container class="d-flex align-center">
      ...
      <template v-if="!mobile">
        <v-btn variant="text" @click="scrollTo('features')">Features</v-btn>
        <v-btn variant="text" @click="scrollTo('how-it-works')">Wie es funktioniert</v-btn>
        <ThemeToggle class="mx-2" />
        <v-btn variant="outlined" color="primary" to="/login" class="ml-2">Login</v-btn>
        <v-btn variant="flat" color="primary" to="/register" class="ml-2">Registrieren</v-btn>
      </template>

...
const { trackEvent } = useTracking("lose");
...
const { lose, isLoading, isChecking, isDeleting, fetchLose, createLos, updateLos, deleteLos, quickCheck } = useLos();
...
const anbieterFilterItems = computed(() => Object.values(ANBIETER).map((a) => ({ title: a.name, value: a.slug })));
